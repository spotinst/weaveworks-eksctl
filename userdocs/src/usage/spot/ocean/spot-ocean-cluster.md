...
### Note:
spotOcean object in the configuration file on cluster level will define default VNG properties, spotOcean object in the configuration file on a specific nodegroup level will define a custom VNG properties for this nodegroup.\
