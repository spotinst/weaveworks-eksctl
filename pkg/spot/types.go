...
type (
	...
	NodeGroupResource struct {
		...
		LaunchSpec *LaunchSpec `json:"oceanLaunchSpec,omitempty"`
	}
	...
	Compute struct {
		...
		LaunchSpecification *LaunchSpec    `json:"launchSpecification,omitempty"`
	}
	...
	AutoScaler struct {
		...
		Headrooms    []*Headroom `json:"headrooms,omitempty"` // launchspec
	}
