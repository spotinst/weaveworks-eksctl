...
func NewNodeGroupResourceSet(ec2API awsapi.EC2, iamAPI awsapi.IAM, spec *api.ClusterConfig, ng *api.NodeGroup, bootstrapper nodebootstrap.Bootstrapper, sharedTags []*cfn.Tag, forceAddCNIPolicy bool, vpcImporter vpc.Importer) *NodeGroupResourceSet {
...
func (n *NodeGroupResourceSet) addResourcesForNodeGroup(ctx context.Context) error {
	...
	launchTemplateData, err := n.newLaunchTemplateData(ctx)
	if err != nil {
...
func (n *NodeGroupResourceSet) newLaunchTemplateData(ctx context.Context) (*gfnec2.LaunchTemplate_LaunchTemplateData, error) {
