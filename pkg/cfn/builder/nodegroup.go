...
func NewNodeGroupResourceSet(provider api.ClusterProvider, spec *api.ClusterConfig, clusterStackName string, sharedTags []*cfn.Tag, ng *api.NodeGroup,
...
func (n *NodeGroupResourceSet) newNodeGroupAutoScalingGroupResource(launchTemplate *gfn.AWSEC2LaunchTemplate, vpcZoneIdentifier interface{}, tags []map[string]interface{}) (*awsCloudFormationResource, error) {
	ng := n.spec
...
func (n *NodeGroupResourceSet) mixedInstancesPolicy(launchTemplateName *gfn.Value) map[string]interface{} {
	ng := n.spec
