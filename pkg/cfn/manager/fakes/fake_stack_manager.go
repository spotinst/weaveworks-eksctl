...
type FakeStackManager struct {
	...
	NewNodeGroupTaskStub        func([]*v1alpha5.NodeGroup, []*v1alpha5.ManagedNodeGroup, bool, vpc.Importer) (*tasks.TaskTree, error)
	...
	NewTasksToCreateClusterWithNodeGroupsStub        func([]*v1alpha5.NodeGroup, []*v1alpha5.ManagedNodeGroup, ...tasks.Task) (*tasks.TaskTree, error)
...
func (fake *FakeStackManager) NewNodeGroupTask(arg1 []*v1alpha5.NodeGroup, arg2 []*v1alpha5.ManagedNodeGroup, arg3 bool, arg4 vpc.Importer) (*tasks.TaskTree, error) {
	...
	fake.recordInvocation("NewNodeGroupTask", []interface{}{arg1Copy, arg2Copy, arg3, arg4})
...
func (fake *FakeStackManager) NewNodeGroupTaskCalls(stub func([]*v1alpha5.NodeGroup, []*v1alpha5.ManagedNodeGroup, bool, vpc.Importer) (*tasks.TaskTree, error)) {
	fake.newNodeGroupTaskMutex.Lock()
	defer fake.newNodeGroupTaskMutex.Unlock()
	fake.NewNodeGroupTaskStub = stub
}

func (fake *FakeStackManager) NewNodeGroupTaskArgsForCall(i int) ([]*v1alpha5.NodeGroup, []*v1alpha5.ManagedNodeGroup, bool, vpc.Importer) {
	fake.newNodeGroupTaskMutex.RLock()
	defer fake.newNodeGroupTaskMutex.RUnlock()
...
func (fake *FakeStackManager) NewTasksToCreateClusterWithNodeGroups(arg1 []*v1alpha5.NodeGroup, arg2 []*v1alpha5.ManagedNodeGroup, arg3 ...tasks.Task) (*tasks.TaskTree, error) {
	var arg1Copy []*v1alpha5.NodeGroup
	if arg1 != nil {
		arg1Copy = make([]*v1alpha5.NodeGroup, len(arg1))
		copy(arg1Copy, arg1)
...
func (fake *FakeStackManager) NewTasksToCreateClusterWithNodeGroupsCalls(stub func([]*v1alpha5.NodeGroup, []*v1alpha5.ManagedNodeGroup, ...tasks.Task) (*tasks.TaskTree, error)) {
	fake.newTasksToCreateClusterWithNodeGroupsMutex.Lock()
...
func (fake *FakeStackManager) NewUnmanagedNodeGroupTaskCalls(stub func([]*v1alpha5.NodeGroup, bool, vpc.Importer) *tasks.TaskTree) {
	fake.newUnmanagedNodeGroupTaskMutex.Lock()
	defer fake.newUnmanagedNodeGroupTaskMutex.Unlock()
	fake.NewUnmanagedNodeGroupTaskStub = stub
}

func (fake *FakeStackManager) NewUnmanagedNodeGroupTaskArgsForCall(i int) ([]*v1alpha5.NodeGroup, bool, vpc.Importer) {
	fake.newUnmanagedNodeGroupTaskMutex.RLock()
	defer fake.newUnmanagedNodeGroupTaskMutex.RUnlock()
