...
type StackManager interface {
	...
	NewNodeGroupTask(nodeGroups []*v1alpha5.NodeGroup, managedNodeGroups []*v1alpha5.ManagedNodeGroup, forceAddCNIPolicy bool, vpcImporter vpc.Importer) (*tasks.TaskTree, error)
	NewManagedNodeGroupTask(nodeGroups []*v1alpha5.ManagedNodeGroup, forceAddCNIPolicy bool, importer vpc.Importer) *tasks.TaskTree
	NewSpotOceanNodeGroupTask(importer vpc.Importer) (*tasks.TaskTree, error)
	...
	NewTasksToCreateClusterWithNodeGroups(nodeGroups []*v1alpha5.NodeGroup, managedNodeGroups []*v1alpha5.ManagedNodeGroup, supportsManagedNodes bool, postClusterCreationTasks ...tasks.Task) (*tasks.TaskTree, error)
