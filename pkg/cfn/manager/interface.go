...
type StackManager interface {
	...
	NewTasksToCreateClusterWithNodeGroups(nodeGroups []*v1alpha5.NodeGroup,
		managedNodeGroups []*v1alpha5.ManagedNodeGroup, supportsManagedNodes bool, postClusterCreationTasks ...tasks.Task) (*tasks.TaskTree, error)
	NewNodeGroupTask(nodeGroups []*v1alpha5.NodeGroup, managedNodeGroups []*v1alpha5.ManagedNodeGroup, supportsManagedNodes, forceAddCNIPolicy bool, importer vpc.Importer) (*tasks.TaskTree, error)
	...
	NewSpotOceanNodeGroupTask(nodeGroups []*v1alpha5.NodeGroup, importer vpc.Importer) (*tasks.TaskTree, error)
